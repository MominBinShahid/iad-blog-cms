...
$this->title = 'Posts';
 ...
 ?>
    ...
    ?>
        ...
        <p class="lead">You have successfully loged in as <?= Yii::$app->user->identity->username ?> </p>
    ...
    <?php
     ...
     ?>
        ...
        <div class="text-center">
         <?= Html::a('<span class="glyphicon glyphicon-ok"></span> Create A Post Of Your Own <span class="glyphicon glyphicon-remove"></span>', ['create'], ['class' => 'btn btn-primary btn-lg']) ?>
...
<div class="posts_wrapper" style="position: relative;">
    ...
    <?php if($post->post_image != '') 
        ...
        <div class="text-center">
        <img src="../uploads/<?= $post->post_image ?>" style="width: 700px" class="img-thumbnail img-responsive">    
        </div>
...
<div class="text-right">
 <?= Html::a('Edited gii version of this page <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>', ['index'], ['class' => 'btn btn-default btn-sm']) ?>
<div>
